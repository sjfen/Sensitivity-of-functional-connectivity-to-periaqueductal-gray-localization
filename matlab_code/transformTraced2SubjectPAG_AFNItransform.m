...
%original datset
function AnalysisOutput = transformTraced2SubjectPAG_AFNItransform(AnalysisInput)
% AnalysisInput
...
try
    ...
    for i = 1:length(AnalysisInput.Files)
        ...
        command1 = ['flirt -in /Users/amplmember/GoogleDrive/2017_MAPP_Sonja_PAG/PAG_Datasets/MAPP_18Participants_PAGProject/inpt_mprage.nii.gz -ref /Volumes/AmplStorage2/Experiments/preproc/inpt/SUMA/inpt_SurfVol.nii -omat ' TempDir filesep 'traceROI_transform_inpt.mat'];
        command2 = ['applyxfm4d /Users/amplmember/GoogleDrive/2017_MAPP_Sonja_PAG/PAG_Datasets/MAPP_18Participants_TracedbyDoug/PAGMASK_inpt_mprage.nii.gz /Volumes/AmplStorage2/Experiments/preproc/inpt/SUMA/inpt_SurfVol.nii ' TempDir filesep 'traced2subj_inpt.nii.gz ' TempDir filesep 'traceROI_transform_inpt.mat -singlematrix'];
        ...
        command8 = ['rm ~/Desktop/transformTraced2SubjectPAG_AFNItransform_temp/*'];
        system(command8)
