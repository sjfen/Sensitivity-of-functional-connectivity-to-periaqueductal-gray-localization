%add global mean to subjects used in voxelwise group analysis
...
%change Wei to MNI through search and replace!
    ...
    for i = 1:NumPart
        ...
        if exist(MetaDataPath, 'file')==2
            if exist(pb04file,'file')==2 & exist(errtsfile,'file')==2
                ...
                %first separate based on healthy control or patient dataset, then
                ...
                command2 = ['3dcalc -prefix HealthyControl/Male/demean/globemean/zcoefMNI2_' id_name '+tlrc.HEAD -a HealthyControl/Male/demean/zcoefMNI_' id_name '+tlrc.HEAD -b meanMNItotal+tlrc. -expr ''a+b''']
                command3 = ['3dcalc -prefix HealthyControl/Female/demean/globemean/zcoefMNI2_' id_name '+tlrc.HEAD -a HealthyControl/Female/demean/zcoefMNI_' id_name '+tlrc.HEAD -b meanMNItotal+tlrc. -expr ''a+b''']
                command4 = ['3dcalc -prefix Patients/Male/demean/globemean/zcoefMNI2_' id_name '+tlrc.HEAD -a Patients/Male/demean/zcoefMNI_' id_name '+tlrc.HEAD -b meanMNItotal+tlrc. -expr ''a+b''']
                command5 = ['3dcalc -prefix Patients/Female/demean/globemean/zcoefMNI2_' id_name '+tlrc.HEAD -a Patients/Female/demean/zcoefMNI_' id_name '+tlrc.HEAD -b meanMNItotal+tlrc. -expr ''a+b''']
